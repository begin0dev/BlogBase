...
const Account = ({ accountState, changeAccountFormValue }: IProps) => (
    ...
    <div className={cx('sign-in')}>
      ...
      <div className={cx('row', 'input-wrap')}>
        <div className={cx('input-row')}>
          <TextInput type="text" name="email" label="Email" value={accountState.form.email} placeholder="Enter your Email" color="#00b0ff" setValue={changeAccountFormValue} />
        </div>
        <div className={cx('input-row')}>
          <TextInput type="password" name="password" label="Password" value={accountState.form.password} placeholder="Enter your Password" color="#00b0ff" setValue={changeAccountFormValue} />
        </div>
      </div>
